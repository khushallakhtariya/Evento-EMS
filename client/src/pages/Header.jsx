  ...
  return (
    <div>
      ...
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center'>
          ...
          {storedUserData?.role === "admin" && <Link to={'/createEvent'}> {/*TODO:Route create event page after creating it */}
          ...
          {/* <div className='relative group'>
            <div className='flex flex-col place-items-center py-1 px-3 rounded cursor-pointer hover:text-primarydark hover:bg-white hover:shadow-sm shadow-gray-200 hover:transition-shadow duration-1500'>
              ...
              <div className='absolute top-8 right-7 hidden group-hover:flex flex-row gap-2 h-20 w-20'>
                <img src="src/assets/hola.png" alt="First" className='w-20 h-20'/>
                <img src="src/assets/hola.png" alt="Second" className='w-20 h-20'/> 
              </div>
            </div>
          </div> */}
