                          ...
                          className='
                            ...
                            <br/>
                              ...
                              <ul className="custom-list">
                                  ...
                                  <li> Each individual is allowed to purchase a maximum of 1 tickets for this event to ensure fair distribution. </li>
                    ...
                    "
                      >
                        ...
                        <div className='text-sm flex justify-between' >
                              ...
                              <div className='text-right mt-5 mb-6 pr-5'>MRP. {event.ticketPrice}</div>
                        </div>
